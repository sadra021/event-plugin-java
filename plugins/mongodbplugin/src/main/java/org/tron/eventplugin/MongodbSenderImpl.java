...
public class MongodbSenderImpl {
    ...
    private void createCollections() {
        if (mongoConfig.enabledIndexes()) {
            ...
            HashMap<String, Boolean> walletIndexOption = new HashMap<>();
            walletIndexOption.put("wallet_address", true);
            ...
            mongoManager.createCollection("publicAddresses");
        }
        ...
        createMongoTemplate("publicAddresses");
    }
